const SellingDetails = () => {
  return (
    <div className="text-center">
     ...
     <p className="md:w-1/2 mx-auto">Our dedication to quality has been recognized through numerous accolades, including multiple industry awards for excellence in hospitality and guest service.</p>
     </div>
      <div className="md:stats shadow">
        ...
        <div className="stat place-items-center">
          ...
          <div className="stat-desc text-secondary"> 40 (2%)</div>
        </div>
